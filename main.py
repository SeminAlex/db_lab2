...
class CardsWindow(tk.Toplevel):
    def __init__(self):
        ...
        self.add_record = tk.PhotoImage(file="add.png")
        self.edit_record = tk.PhotoImage(file="edit.png")
        self.delete_record = tk.PhotoImage(file="delete.png")
        self.find_record = tk.PhotoImage(file="find.png")
